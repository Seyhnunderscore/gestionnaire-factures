"""
FONCTION AMÉLIORÉE POUR LA RECHERCHE ET LA SAISIE DES CODES DANS LES FICHIERS EXCEL DE FACTURATION

Cette version améliorée de la fonction save_invoice_file inclut les améliorations suivantes:
1. Utilisation d'une fonction d'aide pour la détection des numéros de facture
2. Recherche plus robuste des factures avec plusieurs formats possibles
3. Recherche étendue si la recherche standard ne trouve pas de correspondance
4. Meilleure gestion des correspondances entre l'UH et les noms de feuilles
5. Plus de logs pour faciliter le débogage

INSTRUCTIONS D'INTÉGRATION:
1. Ajoutez d'abord la fonction d'aide "est_facture_correspondante" juste avant la fonction save_invoice_file
2. Remplacez ensuite le contenu de la fonction save_invoice_file par le code ci-dessous
3. Testez la fonction avec des fichiers Excel réels

"""

# Fonction d'aide à ajouter juste avant save_invoice_file
...
# Nouvelle implémentation de save_invoice_file
